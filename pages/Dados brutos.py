...
def msg_sucesso():
    sucesso = st.success('Arquivo baixado com sucess!', icon = "✅")
    time.sleep(5)
    sucesso.empty()
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o download da tabela em csv', data = converte_csv(dados_filtrados), file_name=nome_arquivo, mime = 'text/csv', on_click= msg_sucesso)
